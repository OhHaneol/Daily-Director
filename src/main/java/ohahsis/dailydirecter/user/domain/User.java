...
@Builder            // 해당 클래스에 해당하는 엔티티 객체를 만들 때 빌더 패턴을 이용해서 만들 수 있도록 지정해주는 어노테이션이다. Board.builder(). {여러가지 필드의 초기값 선언 }. build() 형태로 객체를 만들 수 있다.
...
public class User extends BaseEntity {
    ...
    // TODO @ManyToOne 같은 글쓰기 연관 속성 추가
}
